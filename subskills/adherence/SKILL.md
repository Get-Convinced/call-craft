...
scorer's output against the six calibration rules: rep-quote grounding, read-the-whole-turn,
scale-anchoring, the craft-versus-outcome firewall, MEDDIC-earned-on-the-call, and anti-slop. It returns
a verdict per rep and a spot re-score on the dims it most disagrees with. This is the quality control on
